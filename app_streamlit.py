...
if menu == "🎯 1. Dự đoán Khách hàng (Inference)":
    ...
    st.markdown("Phân tích toàn diện **17 thuộc tính hành vi & bối cảnh** từ phiên truy cập người dùng theo chuẩn bộ dữ liệu `online_shoppers.csv`. https://archive.ics.uci.edu/dataset/468/online+shoppers+purchasing+intention+dataset")
